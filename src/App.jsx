...
const PAGES = {
   ...
   * ASSIGNMENTS
   *
   * Admin / Master / Manager assignment management
   */
  assignments: <Assignments />,

  /*
   * Manager's personal assignment checklist
   */
 ...
 *
 * Assignments added here so Managers can
 * quickly access their tasks from mobile.
 */
const MOB_TABS = [
  {
    key: 'pos',
...
function AppContent() {
  ...
  /*
   * Public QR complaint form must work
   * without a Stocko login.
   */
